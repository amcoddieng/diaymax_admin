          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-shrink-0">
                {boutique.logo ? (
                  <img
                    src={`https://98c3-102-164-160-251.ngrok-free.app${boutique.logo}`}
                    alt={boutique.nom}
                          ...
                          <div key={product.id} className="group flex items-center justify-between p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            <div className="flex items-center">
                              <div className="relative">
                                {product.image ? (
                                  <img src={`https://98c3-102-164-160-251.ngrok-free.app${product.image}`} alt={product.nom} className="h-8 w-8 object-cover rounded-md" />
                                ) : (
                    ...
                    {filteredProducts.map((product) => (
                      <div key={product.id} className="group bg-white rounded-lg border border-gray-100 overflow-hidden hover:shadow-md transition-all hover:-translate-y-1">
                        <div className="relative h-32 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                          {product.image ? (
                            <img src={`https://98c3-102-164-160-251.ngrok-free.app${product.image}`} alt={product.nom} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                          ) : (
                          ...
                          return (
                            <tr key={article.id} className="hover:bg-gray-50 transition-colors">
                              <td className="px-3 py-2 whitespace-nowrap">
                                <div className="flex items-center">
                                  {article.image ? (
                                    <img src={`https://98c3-102-164-160-251.ngrok-free.app${article.image}`} alt={article.sku} className="h-8 w-8 object-cover rounded-lg mr-2" />
                                  ) : (
                                ...
                                <td className="px-3 py-2">
                                  <div className="flex items-center">
                                    ...
                                    >
                                      {document.url ? (
                                        <img
                                          src={`https://98c3-102-164-160-251.ngrok-free.app${document.url}`}
                                          alt={document.nom}
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            ...
            <div className="p-4 flex items-center justify-center">
              {previewDocument.url ? (
                <img
                  src={`https://98c3-102-164-160-251.ngrok-free.app${previewDocument.url}`}
